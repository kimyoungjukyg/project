...
<script>
        var hash = "0b23bb46cc07cdbd4f4eb64c86ac81e242e71f2b0bce55af69362426ba14568b";
        var failUrl = "https://developers.kakao.com/payment/web/fail/bff63966-22b3-4d02-8790-9e1fa3cabe04";
        var remainingSec = 900;
        var cancelUrl = "https://developers.kakao.com/payment/web/cancel/bff63966-22b3-4d02-8790-9e1fa3cabe04";
...
<div class="kakaopay_layer">
		<div class="inner_kakaopay">
			...
			<div class="layer_body">
				...
				<form id="userPost" method="post" action=" /v1/payment/ready HTTP/1.1" >
					<fieldset>
